...
//  LikeButtonSwiftUI
//
//  Created by Shreyas Vilaschandra Bhike on 24/05/21.
//  The App Wizard
            ...
            ZStack {
                ...
                ZStack {
                    ...
                    Image(systemName: "heart.fill")
                        .resizable()
                        .frame(width: 150, height: 130, alignment: .center)
                        .shadow(color: .red, radius: 5, x: 0.0, y: 0.0).opacity(0.7)
                        .aspectRatio(contentMode: .fit)
                        .opacity(touch ? 1 : 0)
    ...
    private var sparks: some View {
        ZStack {
            ...
            Image(systemName: "heart")
                ...
                .offset(x: 10.0, y: touch ? -200 : 10.0)
                .opacity(touch ? 0 : 1)
                .rotationEffect(.degrees((touch ? -20 : 10)))
                .foregroundColor(.red)
                .animation(Animation.timingCurve(0.54, 1.65, 0.68, 0.79, duration: touch ? 1 : 0).delay(touch ? 0.5 : 0))
            ...
            Image(systemName: "heart")
                ...
                .offset(x: 10.0, y: touch ? -200 : 10.0)
                .opacity(touch ? 0 : 1)
                .rotationEffect(.degrees((touch ? 10 : -20)))
                .foregroundColor(.red)
                .animation(Animation.timingCurve(0.54, 1.65, 0.68, 0.79, duration: touch ? 1 : 0).delay(touch ? 1 : 0))
               
            
            Image(systemName: "heart")
                .resizable()
                .frame(width: 100, height: 90, alignment: .center)
                .offset(x: /*@START_MENU_TOKEN@*/10.0/*@END_MENU_TOKEN@*/, y: touch ? -250 : 10.0)
                .opacity(touch ? 0 : 1)
                .rotationEffect(.degrees((touch ? -15 : 10)))
                .foregroundColor(.red)
                .animation(Animation.timingCurve(0.54, 1.65, 0.68, 0.79, duration: touch ? 1 : 0).delay(touch ? 1.5 : 0))
                
            
            Image(systemName: "heart")
                .resizable()
                .frame(width: 100, height: 90, alignment: /*@START_MENU_TOKEN@*/.center/*@END_MENU_TOKEN@*/)
                .offset(x: 10.0, y: touch ? -300 : 10.0)
                .opacity(touch ? 0 : 1)
                .rotationEffect(.degrees((touch ? 10 : -15)))
                .foregroundColor(.red)
                .animation(Animation.timingCurve(0.54, 1.65, 0.68, 0.79, duration: touch ? 1 : 0).delay(touch ? 2 : 0))
